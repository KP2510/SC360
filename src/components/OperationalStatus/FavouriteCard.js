    ...
    render() {
        return (
            <div>
                ...
                >
                    <StarFilled style={{ color: 'orange', margin: '3%' }} />
                    <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '3%' }}>
                        <Text style={{
                            fontSize: 'small',
                            color: 'white'
                        }}>{this.props.kpiData.title}</Text>
                        <Title level={4} style={{ color: 'white', marginBottom: 0, marginTop: '9%' }}>{this.props.kpiData.count.toString().padStart(2, '0')}</Title>
                        <div>
