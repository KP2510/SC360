...
class Bubblechart extends React.Component {
    ...
    componentDidMount = () => {
        ...
        //     })
        this.setState({ bubbleChartData: this.props.dataSet }, () => this.drawBubbleChart(this.state.bubbleChartData))

        //this.drawBubbleChart(this.props.dataSet)
    }
    ...
    drawBubbleChart(data) {
        ...
        var svg = d3.select(this.refs.bubbleChart)
            .append("svg")
        ...
        var tooltip = d3.select(this.refs.bubbleChart)
            .append("div")
            .style("opacity", 0)
            .attr("class", "tooltip")
            .style('display', 'block') // set display 
            .style('position', 'absolute')
            .style('color', '#810f7c')
            .style('background', '#dcd6dc')
        ...
        svg
            ...
            .enter()
            .append("line")
            .attr('x1', function (d) { return xCircle -20 + z(d) })
            .attr('x2', xLabel -20 )
